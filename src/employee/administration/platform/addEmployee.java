...
public class addEmployee extends JFrame implements ActionListener{
    ...
    JTextField name, fname, salary, address, email, phone, desig, an;
    Choice edu;
    JLabel eid;
    JDateChooser dob;
    ...
    addEmployee(){
        ...
        edu.add("Secondary");
        edu.add("Senior Secondary");
        edu.add("Diploma");
        edu.add("Undergraduate");
        edu.add("Postgraduate");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add){
            ...
            String edob=((JTextField)dob.getDateEditor().getUiComponent()).getText();
            ...
            String eedu=(String)edu.getSelectedItem();
            ...
            try{
                ...
                String query="insert into employee values ('"+ename+"', '"+efname+"', '"+edob+"', '"+esalary+"', '"+eaddress+"', '"+ephone+"', '"+eemail+"', '"+eedu+"', '"+edesig+"', '"+ean+"', '"+eeid+"'  )";
